...
console.log(totalPopulation(testy));
*/
...
console.log(ingredients(testyTwo));
*/
...
let myCat = new Cat('Shadow', 3, 'Purple');
...
let myWizard = new Wizard('Merlin', 136, 'Teleport');
myWizard.castSpell();
...
//Code Here
let phoneOne = new Phone('Android', 'Blackberry', 16, 'black', 300);
let phoneTwo = new Phone('Apple', 'Iphone 13', 512, 'Gold', 1099);
let phoneThree = new Phone('Nokia', 'Original', 128, 'Violet', 99);
...
//Code Here
let myFirstVehicle = new Vehicle(8, 'Purple', 500);
...
//Code Here
let myFirstMotorcycle = new Motorcycle(2, 'red', 2000, 'toyota', false);
/*
...
//Code Here
let myFirstBoat = new Boat(100, 'White', 100000, 'Bertram', true, 'Terror', 'Yacht', false);
